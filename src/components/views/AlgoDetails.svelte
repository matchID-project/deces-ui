<div class="rf-container-fluid">
  <div class="rf-grid-row">
    ...
    <div class="rf-col-xl-6 rf-col-lg-6 rf-col-md-6 rf-col-sm-12 rf-col-12">
        ...
        <p>
            La requête est composée d'un bloc de critères obligatoires (<i>blocking</i>), les autres éléments
            de la requête étant optionnels. Les critères obligatoires sont ceux-ci:
        </p>
        <ul>
            <li>
