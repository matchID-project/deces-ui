...
[ -z "${APP}" -o -z "${ES_INDEX}" -o -z "${ES_PROXY_PATH}" -o -z "${ES_HOST}" -o -z "${ES_PORT}" -o -z "${BACKEND_PORT}" -o -z "${BACKEND_HOST}" -o -z "${BACKEND_PROXY_PATH}" ] && echo "missing some env var" && exit 1
